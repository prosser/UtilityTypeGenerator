...
public abstract class UtilityTypeSelector(Func<Compilation, PropertyRecord[]> getProperties)
{
    ...
    protected UtilityTypeSelector(SelectorOrSymbol selectorOrSymbol)
    ...
    protected UtilityTypeSelector(IEnumerable<SelectorOrSymbol> selectorsOrSymbols, Func<IEnumerable<SelectorOrSymbol>, Compilation, IEnumerable<PropertyRecord>> reducer)
